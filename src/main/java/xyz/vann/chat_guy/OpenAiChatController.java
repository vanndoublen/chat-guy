...
public class OpenAiChatController {
    ...
    public String chatGPT(){
        return chatClient.prompt()
                .user("tell me an interesting fact about open ai")
                .call()
                .content();
    }
    ...
    public Flux<Map<String, String>> chatStream(@RequestBody Map<String, String> request){
        try{
            ...
            String systemPrompt = "You are \"Chatgpt Taobao\" and a personal assistant, you know everything.\n" +
                    ...
                    "3. Math: Do not render math formula in Latex format, and do not use code block for math";
